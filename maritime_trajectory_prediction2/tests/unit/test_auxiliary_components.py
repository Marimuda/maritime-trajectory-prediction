...
class TestTrajectoryMetrics:
    ...
    def sample_trajectory(self):
        ...
        return pd.DataFrame(
            {
                "lat": [62.0, 62.01, 62.02, 62.03],
                "lon": [-6.7, -6.69, -6.68, -6.67],
                "time": pd.to_datetime(
                    [
                        "2025-05-08 10:00:00",
                        "2025-05-08 10:01:00",
...
class TestErrorHandling:
    ...
    def test_maritime_utils_error_handling(self):
        ...
        bearing = MaritimeUtils.calculate_bearing(
    ...
    def test_data_cleaning_edge_cases(self):
        ...
        nan_df = pd.DataFrame(
            {"mmsi": [np.nan, np.nan], "lat": [np.nan, np.nan], "lon": [np.nan, np.nan]}
        )
