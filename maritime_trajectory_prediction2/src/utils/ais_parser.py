...
class AISParser:
    ...
    def get_vessel_trajectories(
        self, ais_data: pd.DataFrame | list[pd.DataFrame], mmsi: int = None
    ) -> list[pd.DataFrame]:
        """
    ...
    def prepare_trajectory_for_prediction(
        self,
        ...
        if not available_features:
            raise ValueError(
                f"None of the specified features {features} are available in the trajectory"
            )
