...
class AISWindowDataset(Dataset):
    ...
    def _generate_window_indices(self):
        ...
        for mmsi in self.ds.mmsi.values:
            ...
            valid_mask = (
                vessel_data.latitude.notnull() & 
                vessel_data.longitude.notnull()
            )
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        target_times = valid_times[
            ...
            time_idx + self.window_size + self.prediction_horizon
        ]
        ...
        if self.scaler is not None:
            ...
            target_tensor = (target_tensor - mean[:len(target_tensor), None]) / std[:len(target_tensor), None]
